...
const { loadingState, resource: characters, fetchResource: fetchAllCharacters } = useFetchResource("https://rickandmortyapi.com/api/character");
fetchAllCharacters();
const { loadingState: loadingLocations, resource: locations, fetchResource: fetchLocations } = useFetchResource("https://rickandmortyapi.com/api/character");
fetchLocations();

const orderKey: Ref<string> = ref("id");
